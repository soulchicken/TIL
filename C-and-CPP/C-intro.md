...
- [C의 해부학](#c의-해부학)
- [C 프로그램 훑어보기](#c-프로그램-훑어보기)
- [변수가 편리한 이유](#변수가-편리한-이유)
- [자료형이 필요한 이유](#자료형이-필요한-이유)
- [변수를 선언하는 방법](#변수를-선언하는-방법)
- [printf() 함수의 기본적인 사용법](#printf-함수의-기본적인-사용법)
- [주석 (Comment)](#주석-comment)
- [키워드와 예약어](#키워드와-예약어)
- [함수 만들기](#함수-만들기)
- [디버거 사용법](#디버거-사용법)
- [문법 오류와 문맥 오류](#문법-오류와-문맥-오류)
- [읽기 좋은 코드를 만드는 요령](#읽기-좋은-코드를-만드는-요령)
